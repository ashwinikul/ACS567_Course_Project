...
<?php
    ...
    echo "<canvas width='600px' height='265px' id='graphs' style='border:groove 6px orange;'></canvas>";
    echo "</td></tr><tr><td align='center' valign='top' height='125' width='650' colspan='3'><fieldset><div> <legend>Send result to your mail</legend><div><input type='text' name='email' size='60' value = ". $s_emailid ."><br><input type='submit' name='SendEmail' value='send Email' data-target='send_email' id='btn add btn-success' /></div></div></td></tr>";
    echo "</table>";
    echo "</div>";
    print_r($stack); 
